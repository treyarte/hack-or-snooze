...
class User {
  ...
  /**
   * Method to make a post request to /users/username/favorites/storyId
   * - storyId - the id of the story the user will favorite
   */
  async favoriteStory(storyId) {
    if (!this.loginToken) return null;
  ...
  /**
   * Method to make a delete request to /users/username/favorites/storyId
   * - storyId - the id of the story the user will favorite
   */
